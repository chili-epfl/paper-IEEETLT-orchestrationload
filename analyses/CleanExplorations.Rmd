...
# Validation that PCA is good enough to capture the variance
...
lr4b <- glm(GroundTruth ~ Activity + Social + Focus + PCALoadPos, family=binomial(link='logit'), data=behdata4b) # The PCA load coefficient goes in the right direction, but is not significant
summary(lr4b)
