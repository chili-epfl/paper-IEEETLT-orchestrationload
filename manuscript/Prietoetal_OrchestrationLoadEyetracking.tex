...
\item In our previous work we have explored a mixed quanti/quali approach to studying orchestration load in authentic settings in a more concrete and detailed manner \cite{Prieto2015ectel}. However, we still lack models of orchestration, and reliable measures to help us compare different classroom situations in terms of orchestration load
...
\section{A Model of Factors in Real-time Classroom Orchestration}
