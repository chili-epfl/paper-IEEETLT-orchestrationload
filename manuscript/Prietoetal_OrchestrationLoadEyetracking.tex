...
TODO: Add the manipulated variables too (teacher experience, usual technology, external help) as possibilities in the black bubble!?
...
\item Can the application of this measures and models provide us with insights about the orchestration load of a certain classroom situation?
\end{enumerate}
...
\item Finally, the fourth case study was not manipulated, and is provided rather as an illustrative example of how the models and methods can be used to extract insights about the orchestration load of a certain classroom/situation (hence, addressing RQ2)
...
first two sessions of case 2 \cite{Prieto2015ectel}. However, the application of the statistical models and methods depicted in sections \ref{sec:model} and \ref{sec:measures} in completely new
\item Below, we describe only the main results of the case studies. The datasets generated, full analytical code and detailed results are available online\footnote{(add github link)}
\end{itemize}
...
\hline
\hline
Case 1 & University & 1 expert, 1 novice & 2+1 (45-65') & Laptops, classroom projector & Validate measure/model & Teacher expertise (novice vs. expert) \\
\hline
Case 2 & Primary school & 1 expert & 2+2 (80') & Laptops, classroom projector // Tabletops, classroom projector & Validate measure/model & Familiarity with technology (usual vs. novel) \\
\hline
Case 3 & Open doors (primary) & 1 novice (researcher) & 4 (35-45') & Tabletops, classroom projector & Validate measure/model & External (human) help (without/with helper) \\
\hline
Case 4 & Open doors (primary) & 1 novice (researcher) & 3 (35-45') & Tabletops & Illustrate use & -- \\
\hline
\end{tabular}
\end{table*}
